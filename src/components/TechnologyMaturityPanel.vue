                    ...
                    <div class="w-[60%] p-5 flex items-center">
                        <div class="w-full space-y-2">
                            ...
                            <div 
                                ...
                                :key="index"
                                class="bg-slate-900/50 border border-cyan-500/20 rounded-lg p-3 hover:border-cyan-400/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all cursor-pointer group"
                                @click="openDetail(tech)"
                            >
                                <!-- 技术编号和标题 -->
                                <div class="flex items-center gap-3">
                                    <!-- 数字编号 -->
                                    <div class="flex-shrink-0 w-9 h-9 bg-gradient-to-br from-cyan-500/30 to-cyan-600/30 border-2 border-cyan-400/60 rounded-lg flex items-center justify-center shadow-[0_0_10px_rgba(6,182,212,0.3)] group-hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] group-hover:border-cyan-300 transition-all">
                                        <span class="text-lg font-bold text-cyan-300 group-hover:text-cyan-200 font-['Orbitron']">{{ index + 1 }}</span>
                                    </div>
                                    ...
                                    <!-- 查看详情箭头 -->
                                    <div class="flex-shrink-0 text-cyan-400 group-hover:text-cyan-300 transition-colors">
