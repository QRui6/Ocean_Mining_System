...
@Entity
@Table(name = "site_forecasts_hourly")
public class SiteForecastHourly {
    ...
    @Column(name = "wind_speed", precision = 8, scale = 3)
    private BigDecimal windSpeed;

    @Column(name = "wind_dir", precision = 8, scale = 3)
    private BigDecimal windDir;

    @Column(name = "gust", precision = 8, scale = 3)
    private BigDecimal gust;

    @Column(name = "wave_height", precision = 8, scale = 3)
    private BigDecimal waveHeight;

    @Column(name = "wave_period", precision = 8, scale = 3)
    private BigDecimal wavePeriod;

    @Column(name = "wave_dir", precision = 8, scale = 3)
    private BigDecimal waveDir;
    ...
    public BigDecimal getWindDir() { return windDir; }
    public void setWindDir(BigDecimal windDir) { this.windDir = windDir; }

    public BigDecimal getGust() { return gust; }
    public void setGust(BigDecimal gust) { this.gust = gust; }
    ...
    public BigDecimal getWaveDir() { return waveDir; }
    public void setWaveDir(BigDecimal waveDir) { this.waveDir = waveDir; }
